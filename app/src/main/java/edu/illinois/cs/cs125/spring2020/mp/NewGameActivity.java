...
public final class NewGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        View targetSetting = findViewById(R.id.targetSettings);
        View areaSetting = findViewById(R.id.areaSettings);
        targetSetting.setVisibility(View.GONE);
        areaSetting.setVisibility(View.GONE);
        ...
        modeGroup.setOnCheckedChangeListener((unused, checkedId) -> {
            ...
            if (checkedId == R.id.targetModeOption) {
                targetSetting.setVisibility(View.VISIBLE);
                areaSetting.setVisibility(View.GONE);

            } else if (checkedId == R.id.areaModeOption) {
                areaSetting.setVisibility(View.VISIBLE);
                targetSetting.setVisibility(View.GONE);
