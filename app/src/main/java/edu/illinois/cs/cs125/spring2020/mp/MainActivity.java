...
public final class MainActivity extends AppCompatActivity {
    ...
    private void setUpUi(final JsonObject result) {
        ...
        for (JsonElement g : games) {
            ...
            if (summary.isOngoing(myEmail)) {
                ...
                leave.setOnClickListener(v -> WebApi.startRequest(this, WebApi.API_BASE
                        + "/games/" + gameId + "/leave", Request.Method.POST, null, response -> {
    ...
    /** open Game activity.
     *
     * @param gameID game's unique id
     */
    public void openGameActivity(final String gameID) {
